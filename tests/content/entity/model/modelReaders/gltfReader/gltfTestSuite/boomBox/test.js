...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", [["", "tier.os.gpu"]], function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/BoomBox/glTF/BoomBox.gltf',
    ...
    nitpick.addStepSnapshot("BoomBox.gltf Model is visible");
